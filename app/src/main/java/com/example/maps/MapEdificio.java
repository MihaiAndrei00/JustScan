...
import com.example.just_scan.databinding.ActivityMapEdificioBinding;
...
public class MapEdificio extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(R.id.mapEdificio);
